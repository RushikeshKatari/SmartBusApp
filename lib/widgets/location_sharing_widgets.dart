      ...
      child: Row(children: [
        Container(
            ...
            decoration: const BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(color: Color(0xAA22C55E), blurRadius: 10)
                ])),
...
class TripInfoCard extends StatelessWidget {
  ...
  final String busNumber, route, driver;
  @override
  Widget build(BuildContext context) => SurfaceCard(
          child: Row(children: [
        Container(
...
class SessionTimerCard extends StatelessWidget {
  const SessionTimerCard({super.key, required this.time});
  final String time;
  @override
  Widget build(BuildContext context) => SurfaceCard(
      ...
      child: Row(children: [
        ...
        const Expanded(
            child: Text('Current session time',
...
class ModernQRScannerOverlay extends StatefulWidget {
  const ModernQRScannerOverlay({super.key});
  @override
  State<ModernQRScannerOverlay> createState() => _ModernQRScannerOverlayState();
}

class _ModernQRScannerOverlayState extends State<ModernQRScannerOverlay>
  ...
  Widget build(BuildContext context) => Container(
      ...
      child: Stack(alignment: Alignment.center, children: [
        ...
        const Icon(Icons.qr_code_scanner_rounded,
            size: 94, color: Colors.white),
        const Positioned(
            bottom: 24,
            child: Text('Ready to scan secure bus QR',
