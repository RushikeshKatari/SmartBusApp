  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: ListView(padding: const EdgeInsets.all(20), children: [
          ...
          TripInfoCard(
              busNumber: b.number,
              route: 'Central Library → College Campus',
              driver: b.driver),
          const SizedBox(height: 13),
          SessionTimerCard(time: p.sessionTime),
          const SizedBox(height: 13),
          const Row(children: [
            Expanded(
                child: SharingStatusCard(
          ...
          const SurfaceCard(
              ...
              child:
                ...
                Icon(Icons.info_outline_rounded, color: AppColors.success),
                SizedBox(width: 11),
                Expanded(
                    child: Column(
                      ...
                      Text('Location sharing is active',
                          style: TextStyle(fontWeight: FontWeight.w800)),
                      SizedBox(height: 3),
                      Text('Your phone is currently sharing this bus location.',
                          style:
